...
import { Send, FileText, MessageSquare, Sprout, PlusCircle, Trash2, Sparkles } from 'lucide-react';
...
const SproutAiPage = () => {
  ...
  return (
    <div className="container">
      <InstructionalCarousel pageId="sproutai" slides={SPROUTAI_CAROUSEL_SLIDES} newUserOnly={false} />
      <Navbar />
